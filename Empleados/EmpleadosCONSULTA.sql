...
select nombre as 'nombre', apellido1 as '1e. apellido ', apellido2 as '2º apellido'  from empleado;
...
select distinct codigo as 'Departamento del empleado' from empleado;
-- 7. Lista el nombre y apellidos de los empleados en una única columna. 
select concat_ws(" ", nombre, apellido1, apellido2) as 'Nombre de Pila' from empleado;

-- 8. Lista el nombre y apellidos de los empleados en una única columna, convirtiendo todos los caracteres en mayúscula. 
select upper(concat_ws(" ", nombre, apellido1, apellido2)) as 'Nombre de Pila' from empleado;

-- 9. Lista el nombre y apellidos de los empleados en una única columna, convirtiendo todos los caracteres en minúscula. 
select lower(concat_ws(" ", nombre, apellido1, apellido2)) as 'Nombre de Pila' from empleado;
...
select codigo as 'clave', substring(nifl, 1, 8) as 'numeros nif', substring(nifl, 9, 1) as 'Letra Nif' from empleado;
...
-- los gastos que se han generado (columna gastos, crear con ALTER). Tenga en cuenta que en algunos casos pueden existir valores negativos. 
-- Utilice un alias apropiado para la nueva columna  que está calculando. 
alter table departamento add gastos double;
SET SQL_SAFE_UPDATES = 0;
update departamento set gastos = 2000000 where nombre = 'Compras';
update departamento set gastos = 750000 where nombre = 'Logistica';
update departamento set gastos = 9000000 where nombre = 'Marketing';
update departamento set gastos = 3000000 where nombre = 'Contabilidad';
update departamento set gastos = 35000000 where nombre = 'Dirección';

select nombre, presupuesto - gastos from departamento;

-- 12. Lista el nombre de los departamentos y el valor del presupuesto actual ordenado de forma ascendente. 
select nombre, presupuesto - gastos from departamento order by presupuesto - gastos asc;
...
-- 35. Lista los nombres, apellidos y nif de los empleados que trabajan en el departamento 3. 36. Lista los nombres, apellidos y nif de los empleados que trabajan en los departamentos 2, 4 o 5.
select nombre, apellido1, apellido2, nifI from empleado where codigo_departamento = 2;

-- 36. Lista los nombres, apellidos y nif de los empleados que trabajan en los 
-- departamentos 2, 4 o 5.
select nombre, apellido1, apellido2, nif from empleado where codigo_departamento = 2
or codigo_departamento = 4 or codigo_departamento = 5;
